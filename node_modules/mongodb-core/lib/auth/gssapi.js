 ...
 * @class
 * @return ***REMOVED***GSSAPI***REMOVED*** A cursor instance
 */
var GSSAPI = function(bson) ***REMOVED***
  this.bson = bson;
  this.authStore = [];
***REMOVED***;
 ...
 */
GSSAPI.prototype.auth = function(server, connections, db, username, password, options, callback) ***REMOVED***
  var self = this;
  ...
  server(
    ...
    ***REMOVED***),
    function(err, r) ***REMOVED***
      ...
      mongo_auth_process.transition(r.result.payload, function(err, payload) ***REMOVED***
        if (err) return callback(err, false);
  ...
  ***REMOVED***;
  ...
  server(
    ...
    ***REMOVED***),
    function(err, r) ***REMOVED***
      if (err) return callback(err, false);
      mongo_auth_process.transition(null, function(err) ***REMOVED***
 ...
 * @return ***REMOVED***object***REMOVED***
 */
GSSAPI.prototype.logout = function(dbName) ***REMOVED***
 ...
 * @return ***REMOVED***object***REMOVED***
 */
GSSAPI.prototype.reauthenticate = function(server, connections, callback) ***REMOVED***
