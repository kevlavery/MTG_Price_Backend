 ...
 * @class
 * @return ***REMOVED***X509***REMOVED*** A cursor instance
 */
var X509 = function(bson) ***REMOVED***
  this.bson = bson;
  this.authStore = [];
***REMOVED***;
 ...
 */
X509.prototype.auth = function(server, connections, db, username, password, callback) ***REMOVED***
  var self = this;
  // Total connections
 ...
 * @return ***REMOVED***object***REMOVED***
 */
X509.prototype.logout = function(dbName) ***REMOVED***
 ...
 * @return ***REMOVED***object***REMOVED***
 */
X509.prototype.reauthenticate = function(server, connections, callback) ***REMOVED***
