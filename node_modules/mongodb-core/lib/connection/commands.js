 ...
 * QUERY
 **************************************************************/
var Query = function(bson, ns, query, options) ***REMOVED***
  var self = this;
...
Query.prototype.incRequestId = function() ***REMOVED***
  this.requestId = _requestId++;
***REMOVED***;

//
// Assign a new request Id
Query.nextRequestId = function() ***REMOVED***
  return _requestId + 1;
***REMOVED***;

//
// Uses a single allocated buffer for the process, avoiding multiple memory allocations
Query.prototype.toBin = function() ***REMOVED***
  var self = this;
  var buffers = [];
  var projection = null;
  ...
  ***REMOVED***
  ...
  if (this.slaveOk) ***REMOVED***
    flags |= OPTS_SLAVE;
  ***REMOVED***

  if (this.oplogReplay) ***REMOVED***
    flags |= OPTS_OPLOG_REPLAY;
  ***REMOVED***

  if (this.noCursorTimeout) ***REMOVED***
    flags |= OPTS_NO_CURSOR_TIMEOUT;
  ***REMOVED***

  if (this.awaitData) ***REMOVED***
    flags |= OPTS_AWAIT_DATA;
  ***REMOVED***

  if (this.exhaust) ***REMOVED***
    flags |= OPTS_EXHAUST;
  ***REMOVED***

  if (this.partial) ***REMOVED***
    flags |= OPTS_PARTIAL;
  ***REMOVED***
  ...
  // Serialize the query
  var query = self.bson.serialize(this.query, ***REMOVED***
  ...
  ***REMOVED***);
  ...
  if (self.returnFieldSelector && Object.keys(self.returnFieldSelector).length > 0) ***REMOVED***
    // Serialize the projection document
    projection = self.bson.serialize(this.returnFieldSelector, ***REMOVED***
      checkKeys: this.checkKeys,
      serializeFunctions: this.serializeFunctions,
      ignoreUndefined: this.ignoreUndefined
    ***REMOVED***);
...
Query.getRequestId = function() ***REMOVED***
  return ++_requestId;
***REMOVED***;
 ...
 * GETMORE
 **************************************************************/
var GetMore = function(bson, ns, cursorId, opts) ***REMOVED***
...
//
// Uses a single allocated buffer for the process, avoiding multiple memory allocations
GetMore.prototype.toBin = function() ***REMOVED***
 ...
 * KILLCURSOR
 **************************************************************/
var KillCursor = function(bson, ns, cursorIds) ***REMOVED***
  this.ns = ns;
  this.requestId = _requestId++;
...
//
// Uses a single allocated buffer for the process, avoiding multiple memory allocations
KillCursor.prototype.toBin = function() ***REMOVED***
  ...
  for (var i = 0; i < this.cursorIds.length; i++) ***REMOVED***
    // Write cursor id
...
var Response = function(bson, message, msgHeader, msgBody, opts) ***REMOVED***
  opts = opts || ***REMOVED*** promoteLongs: true, promoteValues: true, promoteBuffers: false ***REMOVED***;
  this.parsed = false;
  this.raw = message;
  this.data = msgBody;
  this.bson = bson;
...
Response.prototype.isParsed = function() ***REMOVED***
  return this.parsed;
***REMOVED***;

Response.prototype.parse = function(options) ***REMOVED***
  ...
  ***REMOVED***;
  ...
  //
  if (this.numberReturned === 1 && documentsReturnedIn != null && raw) ***REMOVED***
    ...
    var fieldsAsRaw = ***REMOVED******REMOVED***;
  ...
  ***REMOVED***
  ...
  // Parse Body
  //
  for (var i = 0; i < this.numberReturned; i++) ***REMOVED***
    bsonSize =
      this.data[this.index] |
      (this.data[this.index + 1] << 8) |
      (this.data[this.index + 2] << 16) |
