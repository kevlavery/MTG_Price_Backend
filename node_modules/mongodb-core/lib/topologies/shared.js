 ...
 *
 * @param ***REMOVED***ClientSession***REMOVED*** session
 */
const getNextTransactionNumber = function(session) ***REMOVED***
 ...
 *
 * @param ***REMOVED***EventEmitter***REMOVED*** listener the EventEmitter to listen to the events for
 * @param ***REMOVED***EventEmitter***REMOVED*** emitter the EventEmitter to relay the events on
 */
