...
function executeWriteOperation(args, options, callback) ***REMOVED***
  ...
  ***REMOVED***
  ...
  const handler = (err, result) => ***REMOVED***
    ...
    if (!isRetryableError(err)) ***REMOVED***
      return callback(err);
    ***REMOVED***
...
function isWriteCommand(command) ***REMOVED***
  ...
  ***REMOVED***
  ...
  const cb = (err, result) => ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (willRetryWrite) ***REMOVED***
      const newOptions = Object.assign(***REMOVED******REMOVED***, options, ***REMOVED*** retrying: true ***REMOVED***);
      return this.command(ns, cmd, newOptions, callback);
    ***REMOVED***

    // Per SDAM, remove primary from replicaset
    if (this.s.replicaSetState.primary) ***REMOVED***
      this.s.replicaSetState.remove(this.s.replicaSetState.primary, ***REMOVED*** force: true ***REMOVED***);
    ***REMOVED***
