...
1.2.27 2015-12-13
-----------------
- Added [options.checkServerIdentity=true] ***REMOVED***boolean|function***REMOVED***. Ensure we check server identify during SSL, set to false to disable checking. Only works for Node 0.12.x or higher. You can pass in a boolean or your own checkServerIdentity override function, (Issue #29).
