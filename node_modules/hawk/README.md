...
const credentialsFunc = function (id, callback) ***REMOVED***
...
const handler = function (req, res) ***REMOVED***

    // Authenticate incoming request

    Hawk.server.authenticate(req, credentialsFunc, ***REMOVED******REMOVED***, (err, credentials, artifacts) => ***REMOVED***

        // Prepare response

        const payload = (!err ? `Hello $***REMOVED***credentials.user***REMOVED*** $***REMOVED***artifacts.ext***REMOVED***` : 'Shoosh!');
        const headers = ***REMOVED*** 'Content-Type': 'text/plain' ***REMOVED***;

        // Generate Server-Authorization response header

        const header = Hawk.server.header(credentials, artifacts, ***REMOVED*** payload, contentType: headers['Content-Type'] ***REMOVED***);
...
const header = Hawk.client.header('http://example.com:8000/resource/1?b=1&a=2', 'GET', ***REMOVED*** credentials: credentials, ext: 'some-app-data' ***REMOVED***);
...
Request(requestOptions, function (error, response, body) ***REMOVED***
    ...
    const isValid = Hawk.client.authenticate(response, credentials, header.artifacts, ***REMOVED*** payload: body ***REMOVED***);

    // Output results

    console.log(`$***REMOVED***response.statusCode***REMOVED***: $***REMOVED***body***REMOVED***` + (isValid ? ' (valid)' : ' (invalid)'));
***REMOVED***);
```
...
const handler = function (req, res) ***REMOVED***
    ...
    Hawk.uri.authenticate(req, credentialsFunc, ***REMOVED******REMOVED***, (err, credentials, attributes) => ***REMOVED***
...
const bewit = Hawk.uri.getBewit('http://example.com:8000/resource/1?b=1&a=2', ***REMOVED*** credentials: credentials, ttlSec: duration, ext: 'some-app-data' ***REMOVED***);
