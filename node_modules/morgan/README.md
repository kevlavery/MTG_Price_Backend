...
``` js
morgan(function (tokens, req, res) ***REMOVED***
  return [
...
morgan('combined', ***REMOVED***
  skip: function (req, res) ***REMOVED*** return res.statusCode < 400 ***REMOVED***
***REMOVED***)
```
...
```js
morgan.token('type', function (req, res) ***REMOVED*** return req.headers['content-type'] ***REMOVED***)
```
...
http.createServer(function (req, res) ***REMOVED***
  ...
  logger(req, res, function (err) ***REMOVED***
...
var accessLogStream = fs.createWriteStream(path.join(__dirname, 'access.log'), ***REMOVED***flags: 'a'***REMOVED***)

// setup the logger
app.use(morgan('combined', ***REMOVED***stream: accessLogStream***REMOVED***))
...
var accessLogStream = rfs('access.log', ***REMOVED***
...
app.use(morgan('dev', ***REMOVED***
  skip: function (req, res) ***REMOVED*** return res.statusCode < 400 ***REMOVED***
***REMOVED***))

// log all requests to access.log
app.use(morgan('common', ***REMOVED***
  stream: fs.createWriteStream(path.join(__dirname, 'access.log'), ***REMOVED***flags: 'a'***REMOVED***)
***REMOVED***))
...
morgan.token('id', function getId (req) ***REMOVED***
  return req.id
***REMOVED***)
...
function assignId (req, res, next) ***REMOVED***
  req.id = uuid.v4()
  next()
***REMOVED***
```
