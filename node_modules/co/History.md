 ...
 * support passing the rest of the arguments to co into the generator
 ...
 ```js
 function *gen(...args) ***REMOVED*** ***REMOVED***
 co(gen, ...args);
 ```
 ...
 * fixed: callback passed as an argument to generators
 * change: `co(function *()***REMOVED******REMOVED***)` now returns a reusable thunk
 * change: `this` must now be passed through the returned thunk, ex. `co(function *()***REMOVED******REMOVED***).call(this)`
