...
test('write 1 byte negative int', function(t) ***REMOVED***
  var writer = new BerWriter();
...
test('write 2 byte negative int', function(t) ***REMOVED***
  var writer = new BerWriter();
...
test('write 3 byte negative int', function(t) ***REMOVED***
  var writer = new BerWriter();
...
test('write 4 byte negative int', function(t) ***REMOVED***
  var writer = new BerWriter();
...
test('resize internal buffer', function(t) ***REMOVED***
  var writer = new BerWriter(***REMOVED***size: 2***REMOVED***);
  writer.writeString('hello world');
  var ber = writer.buffer;
...
test('sequence', function(t) ***REMOVED***
  var writer = new BerWriter(***REMOVED***size: 25***REMOVED***);
