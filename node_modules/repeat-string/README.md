...
* `string` *****REMOVED***String***REMOVED*****: The string to repeat
* `number` *****REMOVED***Number***REMOVED*****: The number of times to repeat the string
* `returns` *****REMOVED***String***REMOVED*****: Repeated string
