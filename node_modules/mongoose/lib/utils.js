...
exports.last = function(arr) ***REMOVED***
...
exports.isPOJO = function(arg) ***REMOVED***
  ...
  if (arguments.length === 1) ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (Array.isArray(path)) ***REMOVED***
      ...
      return singles.map(function(o) ***REMOVED***
        if (o.populate && !(o.match || o.options)) ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (exports.isObject(path)) ***REMOVED***
      ...
      path = path.path;
    ***REMOVED***
  ***REMOVED*** else if (typeof model === 'object') ***REMOVED***
    options = match;
    match = model;
    model = undefined;
  ***REMOVED***
