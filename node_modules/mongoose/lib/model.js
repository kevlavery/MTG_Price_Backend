...
Model.init = function init(callback) ***REMOVED***
  ...
  ***REMOVED***
  ...
  this.$init = new Promise(function(resolve, reject) ***REMOVED***
    if ((_this.schema.options.autoIndex) ||
        (_this.schema.options.autoIndex == null && _this.db.config.autoIndex)) ***REMOVED***
      _this.ensureIndexes(***REMOVED*** _automatic: true ***REMOVED***, function(error) ***REMOVED***
        if (error) ***REMOVED***
          return reject(error);
        ***REMOVED***
        resolve(_this);
 ...
 *     let doc = await Person.findOne(***REMOVED*** name: 'Ned Stark' ***REMOVED***, ***REMOVED*** session ***REMOVED***);
 *     await doc.remove();
 *     // `doc` will always be null, even if reading from a replica set
 *     // secondary. Without causal consistency, it is possible to
 *     // get a doc back from the below query if the query reads from a
 *     // secondary that is experiencing replication lag.
 *     doc = await Person.findOne(***REMOVED*** name: 'Ned Stark' ***REMOVED***, ***REMOVED*** readPreference: 'secondary' ***REMOVED***);
 *
...
Model.startSession = function(options, callback) ***REMOVED***
  return utils.promiseOrCallback(callback, cb => ***REMOVED***
    if (this.collection.buffer) ***REMOVED***
      return this.collection.addQueue(() => ***REMOVED***
  ...
  ***REMOVED***
  ...
  for (i = 0; i < len; i++) ***REMOVED***
    ...
    ***REMOVED***
    ...
    var subPopulate = utils.clone(mod.options.populate, ***REMOVED***
      retainKeyOrder: true
    ***REMOVED***);
