  ...
  ***REMOVED***
  ...
  if (Buffer.isBuffer(value)) ***REMOVED***
    if (!value || !value.isMongooseBuffer) ***REMOVED***
      ...
      if (this.options.subtype != null) ***REMOVED***
 ...
 * ####Example:
 *
 *     var s = new Schema(***REMOVED*** uuid: ***REMOVED*** type: Buffer, subtype: 4 ***REMOVED***);
 *     var M = db.model('M', s);
 *     var m = new M(***REMOVED*** uuid: 'test string' ***REMOVED***);
 *     m.uuid._subtype; // 4
 *
 * @param ***REMOVED***Number***REMOVED*** subtype the default subtype
 * @return ***REMOVED***SchemaType***REMOVED*** this
 * @api public
 */

SchemaBuffer.prototype.subtype = function(subtype) ***REMOVED***
...
SchemaBuffer.prototype.castForQuery = function($conditional, val) ***REMOVED***
  ...
  ***REMOVED***
  ...
  return casted ? casted.toObject(***REMOVED*** transform: false, virtuals: false ***REMOVED***) : casted;
***REMOVED***;
