 ...
 *
 * @param ***REMOVED***Object***REMOVED*** [options]
 * @param ***REMOVED***Boolean***REMOVED*** [options.includeChildren=false] if true, returns children of modified paths as well. For example, if false, the list of modified paths for `doc.colors = ***REMOVED*** primary: 'blue' ***REMOVED***;` will **not** contain `colors.primary`
...
Document.prototype.$toObject = function(options, json) ***REMOVED***
  ...
  ***REMOVED***;
  ...
  if (json && this.schema.options.toJSON) ***REMOVED***
    defaultOptions = utils.options(defaultOptions, clone(this.schema.options.toJSON));
  ***REMOVED*** else if (this.schema.options.toObject) ***REMOVED***
