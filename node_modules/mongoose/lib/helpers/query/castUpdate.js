...
module.exports = function castUpdate(schema, obj, options, context, filter) ***REMOVED***
  if (!obj) ***REMOVED***
    return undefined;
  ***REMOVED***
...
function walkUpdatePath(schema, obj, op, options, context, filter, pref) ***REMOVED***
  ...
  while (i--) ***REMOVED***
    ...
    ***REMOVED*** else ***REMOVED***
      ...
      if (schematype == null) ***REMOVED***
        ...
        if (_res.schematype != null) ***REMOVED***
...
function castUpdateVal(schema, val, op, $conditional, context) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (cond && op !== '$set') ***REMOVED***
    ...
    ***REMOVED***
    return val;
  ***REMOVED*** else if (cond && op === '$set') ***REMOVED***
