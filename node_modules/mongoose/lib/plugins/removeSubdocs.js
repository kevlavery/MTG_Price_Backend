...
module.exports = function(schema) ***REMOVED***
  const unshift = true;
  schema.s.hooks.pre('remove', false, function(next) ***REMOVED***
    ...
    ***REMOVED***
    ...
    each(subdocs, function(subdoc, cb) ***REMOVED***
      subdoc.$__remove(function(err) ***REMOVED***
        cb(err);
      ***REMOVED***);
    ***REMOVED***, function(error) ***REMOVED***
      if (error) ***REMOVED***
        return _this.schema.s.hooks.execPost('remove:error', _this, [_this], ***REMOVED*** error: error ***REMOVED***, function(error) ***REMOVED***
          next(error);
        ***REMOVED***);
      ***REMOVED***
      next();
