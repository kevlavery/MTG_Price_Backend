...
NativeCollection.prototype.onClose = function(force) ***REMOVED***
...
const syncCollectionMethods = ***REMOVED*** watch: true ***REMOVED***;
...
function format(obj, sub) ***REMOVED***
  ...
  ***REMOVED***
  ...
  var x = utils.clone(obj, ***REMOVED***transform: false***REMOVED***);
  var representation;
    ...
    for (var i = 0; i < numKeys; ++i) ***REMOVED***
      ...
      if (x[key]) ***REMOVED***
        ...
        ***REMOVED*** else if (x[key].constructor.name === 'Date') ***REMOVED***
          formatDate(x, key);
        ***REMOVED*** else if (x[key].constructor.name === 'ClientSession') ***REMOVED***
