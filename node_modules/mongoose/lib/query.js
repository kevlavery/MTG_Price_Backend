...
Query.prototype._find = function(callback) ***REMOVED***
  ...
  ***REMOVED***);
  ...
  var cb = function(err, docs) ***REMOVED***
    if (err) ***REMOVED***
      return callback(err);
    ***REMOVED***
...
Query.prototype.count = function(conditions, callback) ***REMOVED***
  if (typeof conditions === 'function') ***REMOVED***
    callback = conditions;
  ...
  ***REMOVED***
  if (useFindAndModify === false) ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (opts.runValidators && doValidate) ***REMOVED***
...
function _updateThunk(op, callback) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (this.options.runValidators) ***REMOVED***
    if (isOverwriting) ***REMOVED***
      doValidate = function(callback) ***REMOVED***
        castedDoc.validate(callback);
      ***REMOVED***;
...
Query.prototype.populate = function() ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (this.options && this.options.readPreference != null) ***REMOVED***
    for (i = 0; i < res.length; ++i) ***REMOVED***
      if (!res[i].options || res[i].options.readPreference == null) ***REMOVED***
