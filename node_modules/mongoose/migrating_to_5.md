...
```javascript
const schema = new Schema(***REMOVED*** name: String ***REMOVED***);
const MyModel = mongoose.model('Test', schema);
schema.pre('find', () => ***REMOVED*** console.log('find!'); ***REMOVED***);

MyModel.find().exec(function() ***REMOVED***
...
mongoose.connect('mongodb://localhost:27017/test').model('Test', new Schema(***REMOVED******REMOVED***));

// Do this instead
mongoose.connect('mongodb://localhost:27017/test');
mongoose.model('Test', new Schema(***REMOVED******REMOVED***));
```
...
```javascript
const blogPostSchema = new Schema(***REMOVED***
  title: String,
  author: ***REMOVED***
...
await BlogPost.create(***REMOVED*** title: 'test', author: author._id ***REMOVED***);
...
// cursor.
const cursor = MyModel.aggregate([***REMOVED*** $match: ***REMOVED*** name: 'Val' ***REMOVED*** ***REMOVED***]).cursor().exec();
...
const cursorWithOptions = MyModel.
  aggregate([***REMOVED*** $match: ***REMOVED*** name: 'Val' ***REMOVED*** ***REMOVED***]).
  cursor(***REMOVED*** batchSize: 10 ***REMOVED***).
  exec();
```
...
function encodeMongoURI (urlString) ***REMOVED***
    if (urlString) ***REMOVED***
...
mongoose.createConnection(`mongodb://aaron:psw@$***REMOVED***host***REMOVED***/fake`);
...
const schema = new Schema(***REMOVED*** name: String ***REMOVED***, ***REMOVED*** toObject: ***REMOVED*** virtuals: true ***REMOVED*** ***REMOVED***);
schema.virtual('answer').get(() => 42);
const MyModel = db.model('MyModel', schema);

const doc = new MyModel(***REMOVED*** name: 'test' ***REMOVED***);
// In mongoose 4.x this prints "undefined", because `***REMOVED*** minimize: false ***REMOVED***`
// overwrites the entire schema-defined options object.
// In mongoose 5.x this prints "42", because `***REMOVED*** minimize: false ***REMOVED***` gets
// merged with the schema-defined options.
console.log(doc.toJSON(***REMOVED*** minimize: false ***REMOVED***).answer);
```
...
```javascript
MyModel.aggregate(***REMOVED*** $match: ***REMOVED*** isDeleted: false ***REMOVED*** ***REMOVED***, ***REMOVED*** $skip: 10 ***REMOVED***).exec(cb);
```
...
const MyModel = mongoose.model('Test', new Schema(***REMOVED***
  boolField: Boolean
***REMOVED***));

MyModel.create(***REMOVED*** boolField: 'not a boolean' ***REMOVED***);
```
...
```javascript
// In mongoose 4.x, this becomes `***REMOVED*** $set: ***REMOVED*** name: 'Baz' ***REMOVED*** ***REMOVED***` despite the `overwrite`
// In mongoose 5.x, this overwrite is respected and the first document with
// `name = 'Bar'` will be replaced with `***REMOVED*** name: 'Baz' ***REMOVED***`
User.where(***REMOVED*** name: 'Bar' ***REMOVED***).update(***REMOVED*** name: 'Baz' ***REMOVED***).setOptions(***REMOVED*** overwrite: true ***REMOVED***);
```
...
```javsscript
const ChildModelSchema = new mongoose.Schema(***REMOVED***
  text: ***REMOVED***
    type: String
  ***REMOVED***
***REMOVED***);
ChildModelSchema.post('save', function(doc) ***REMOVED***
...
***REMOVED***);
const ParentModelSchema = new mongoose.Schema(***REMOVED***
  children: [ChildModelSchema]
***REMOVED***);

const Model = mongoose.model('Parent', ParentModelSchema);
const m = new Model(***REMOVED*** children: [***REMOVED*** text: 'test' ***REMOVED***] ***REMOVED***);
m.save(function() ***REMOVED***
