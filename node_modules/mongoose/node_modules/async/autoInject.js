...
function autoInject(tasks, callback) ***REMOVED***
    ...
    (0, _baseForOwn2.default)(tasks, function (taskFn, key) ***REMOVED***
        var params;
        var fnIsAsync = (0, _wrapAsync.isAsync)(taskFn);
        var hasNoDeps = !fnIsAsync && taskFn.length === 1 || fnIsAsync && taskFn.length === 0;

        if ((0, _isArray2.default)(taskFn)) ***REMOVED***
        ...
        ***REMOVED***
        ...
        function newTask(results, taskCb) ***REMOVED***
            var newArgs = (0, _arrayMap2.default)(params, function (name) ***REMOVED***
                return results[name];
            ***REMOVED***);
            newArgs.push(taskCb);
