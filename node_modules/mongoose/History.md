 ...
 * fix(update): cast `$addToSet: [1, 2]` -> `$addToSet: ***REMOVED*** $each: [1, 2] ***REMOVED***` #6086
 ...
 * fix(connection): allow connecting with ***REMOVED*** mongos: true ***REMOVED*** to handle query params #4032 [burtonjc](https://github.com/burtonjc)
...
==================
  ...
  * added; ***REMOVED***mongoose,db***REMOVED***.modelNames()
  ...
  * fixed; specifying schema type edge case ***REMOVED*** path: [***REMOVED***type: "String" ***REMOVED***] ***REMOVED***
...
==================
  ...
  * fixed; display empty docs as ***REMOVED******REMOVED*** in log output #953 follow up
...
==================
  ...
  * docs; ***REMOVED***g,s***REMOVED***etter introspection #777
...
==================
  ...
  * added; virtual ***REMOVED***g,s***REMOVED***etter introspection (#1070)
...
=========================
  ...
  * removed; mongoose***REMOVED***connectSet,createSetConnection***REMOVED***. use connect,createConnection instead
  ...
  * fixed; array#***REMOVED***$pop,$shift***REMOVED*** mirror MongoDB behavior
  ...
  * fixed; Query#***REMOVED***update,remove***REMOVED***() works without callbacks (#788)
  ...
  * added; support for a configurable minimize option #to***REMOVED***Object,JSON***REMOVED***(option) (#848)
  * added; support for strict: `throws` [regality]
  * added; support for named schema types (#795)
  * added; to***REMOVED***Object,JSON***REMOVED*** schema options (#805)
  * added; findByIdAnd***REMOVED***Update,Remove***REMOVED***()
  * added; findOneAnd***REMOVED***Update,Remove***REMOVED***()
...
===================
  ...
  * deprecated; MongooseNumber#***REMOVED***inc, increment, decrement***REMOVED*** methods
...
===================
  ...
  * fixed; virtuals application of subdocs when using toObject(***REMOVED*** virtuals: true ***REMOVED***) (#889)
...
===================
  ...
  * fixed; Query#***REMOVED***update,remove***REMOVED***() work without callbacks again (#788)
...
==================
  ...
  * Changed; Query#***REMOVED***run,exec***REMOVED*** return promises [aheckmann]
