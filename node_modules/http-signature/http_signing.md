...
<!-- sign ***REMOVED***"name": "Default", "options": ***REMOVED***"keyId":"Test", "algorithm": "rsa-sha256"***REMOVED******REMOVED*** -->
<!-- signstring -->
...
<!-- sign ***REMOVED***"name": "All Headers", "options": ***REMOVED***"keyId":"Test", "algorithm": "rsa-sha256", "headers": ["(request-target)", "host", "date", "content-type", "digest", "content-length"]***REMOVED******REMOVED*** -->
<!-- signstring -->
