...
- [pull #7] Support for `<parser>.help(***REMOVED***helpWrap: false, ...***REMOVED***)` option to be able
...
- [pull #6] Support headings between groups of options (by Joshua M. Clulow)
  so that this code:
        ...
        var options = [
            ***REMOVED*** group: 'Armament Options' ***REMOVED***,
            ***REMOVED*** names: [ 'weapon', 'w' ], type: 'string' ***REMOVED***,
            ***REMOVED*** group: 'General Options' ***REMOVED***,
            ***REMOVED*** names: [ 'help', 'h' ], type: 'bool' ***REMOVED***
        ];
        ...
...
- Fix for `parse.help(***REMOVED***includeEnv: true, ...***REMOVED***)` handling to ensure that an
  option with an `env` **but no `help`** still has the "Environment: ..."
  output. E.g.:

        ***REMOVED*** names: ['foo'], type: 'string', env: 'FOO' ***REMOVED***
