...
hbs.registerHelper('helper_name', function(...) ***REMOVED*** ... ***REMOVED***);
...
```
template.html      -> ***REMOVED******REMOVED***> template***REMOVED******REMOVED***
template 2.html    -> ***REMOVED******REMOVED***> template_2***REMOVED******REMOVED***
login view.hbs     -> ***REMOVED******REMOVED***> login_view***REMOVED******REMOVED***
template-file.html -> ***REMOVED******REMOVED***> template_file***REMOVED******REMOVED***
```
...
```
top level: ***REMOVED******REMOVED***@foo***REMOVED******REMOVED***
***REMOVED******REMOVED***#each items***REMOVED******REMOVED***
  ***REMOVED******REMOVED***label***REMOVED******REMOVED***: ***REMOVED******REMOVED***@foo***REMOVED******REMOVED***
***REMOVED******REMOVED***/each***REMOVED******REMOVED***
```
