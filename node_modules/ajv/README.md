...
var schema = ***REMOVED***
  ...
  "type": "object",
  "properties": ***REMOVED***
    "foo": ***REMOVED*** "$ref": "defs.json#/definitions/int" ***REMOVED***,
    "bar": ***REMOVED*** "$ref": "defs.json#/definitions/str" ***REMOVED***
  ***REMOVED***
***REMOVED***;

var defsSchema = ***REMOVED***
  "$id": "http://example.com/schemas/defs.json",
  "definitions": ***REMOVED***
    "int": ***REMOVED*** "type": "integer" ***REMOVED***,
    "str": ***REMOVED*** "type": "string" ***REMOVED***
  ***REMOVED***
***REMOVED***;
```
...
```javascript
var ajv = new Ajv(***REMOVED***schemas: [schema, defsSchema]***REMOVED***);
...
```javascript
var ajv = new Ajv(***REMOVED***$data: true***REMOVED***);
...
```javascript
ajv.addKeyword('range', ***REMOVED***
  type: 'number',
  compile: function (sch, parentSchema) ***REMOVED***
    var min = sch[0];
    var max = sch[1];
...
ajv.compileAsync(schema).then(function (validate) ***REMOVED***
  var valid = validate(data);
  // ...
***REMOVED***);

function loadSchema(uri) ***REMOVED***
  return request.json(uri).then(function (res) ***REMOVED***
 ...
 * (or with option ***REMOVED***async: true***REMOVED***)
...
.then(function (data) ***REMOVED***
  console.log('Data is valid', data); // ***REMOVED*** userId: 1, postId: 19 ***REMOVED***
***REMOVED***)
...
```javascript
var ajv = new Ajv(***REMOVED*** async: 'es7', processCode: transpileFunc ***REMOVED***);
var validate = ajv.compile(schema); // transpiled es7 async function
validate(data).then(successFunc).catch(errorFunc);
```
...
***REMOVED***
  ...
  loadSchema:       undefined, // function(uri: string): Promise ***REMOVED******REMOVED***
  ...
  messages:         true,
  sourceCode:       false,
  processCode:      undefined, // function (str: string): string ***REMOVED******REMOVED***
  cache:            new Cache,
  serialize:        undefined
***REMOVED***
```
