...
Boom.boomify(error, ***REMOVED*** statusCode: 400 ***REMOVED***);
```
...
```js
var error = Boom.create(400, 'Bad request', ***REMOVED*** timestamp: Date.now() ***REMOVED***);
```
...
```js
Boom.unauthorized('invalid password', 'sample', ***REMOVED*** ttl: 0, cache: null, foo: 'bar' ***REMOVED***);
```
