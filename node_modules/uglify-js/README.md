...
```
$ echo 'var o=***REMOVED***"foo":1, bar:3***REMOVED***; o.foo += o.bar; console.log(o.foo);' | uglifyjs --mangle-props=2 -mc
var o=***REMOVED***"foo":1,a:3***REMOVED***;o.foo+=o.a,console.log(o.foo);
```
...
```js
uglifyJS.minify([ "input.js"], ***REMOVED***
    compress: ***REMOVED***
        dead_code: true,
        global_defs: ***REMOVED***
            DEBUG: false
...
```javascript
function uglify(ast, options, mangle) ***REMOVED***
...
var result = UglifyJS.minify("var b = function () ***REMOVED******REMOVED***;", ***REMOVED***fromString: true***REMOVED***);
```
...
```javascript
var result = UglifyJS.minify(***REMOVED***"file1.js": "var a = function () ***REMOVED******REMOVED***;"***REMOVED***, ***REMOVED***
  outSourceMap: "out.js.map",
  outFileName: "out.js",
  fromString: true
***REMOVED***);
...
```javascript
var result = UglifyJS.minify("compiled.js", ***REMOVED***
...
```javascript
var result = UglifyJS.minify([ "file1.js" ], ***REMOVED***
  outSourceMap: "out.js.map",
...
- `compress` (default `***REMOVED******REMOVED***`) — pass `false` to skip compressing entirely.
  Pass an object to specify custom [compressor options][compressor].

- `parse` (default ***REMOVED******REMOVED***) — pass an object if you wish to specify some
...
##### mangle
  ...
  ***REMOVED***
  ...
  // 'function funcName(a,n)***REMOVED******REMOVED***var globalVar;'

  UglifyJS.minify("tst.js", ***REMOVED*** mangle: ***REMOVED*** except: ['firstLongName'] ***REMOVED*** ***REMOVED***).code;
  // 'function funcName(firstLongName,a)***REMOVED******REMOVED***var globalVar;'

  UglifyJS.minify("tst.js", ***REMOVED*** mangle: ***REMOVED*** toplevel: true ***REMOVED*** ***REMOVED***).code;
  // 'function n(n,a)***REMOVED******REMOVED***var a;'
  ```
...
var stream = UglifyJS.OutputStream(***REMOVED***
	...
