(function () ***REMOVED***
  ...
  dynamicOrigin = function (origin, cb) ***REMOVED***
  ...
  ***REMOVED***;
  ...
  app1 = express();
  app1.use(cors(***REMOVED***origin: dynamicOrigin***REMOVED***));
  app1.use(bodyParser.json());
  app1.post('/', function (req, res) ***REMOVED***
    res.send(req.body);
  ***REMOVED***);
  ...
  app2.use(cors(***REMOVED***origin: dynamicOrigin***REMOVED***));
  app2.post('/', function (req, res) ***REMOVED***
    res.send(req.body);
  ***REMOVED***);

  /* -------------------------------------------------------------------------- */

  describe('body-parser-events', function () ***REMOVED***
    describe('app1 (cors before bodyparser)', function () ***REMOVED***
    ...
    ***REMOVED***);
    ...
    describe('app2 (bodyparser before cors)', function () ***REMOVED***
      it('POST works', function (done) ***REMOVED***
        var body = ***REMOVED***
          example: text
        ***REMOVED***;
