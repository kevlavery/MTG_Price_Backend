...
```js
var source = "<p>Hello, my name is ***REMOVED******REMOVED***name***REMOVED******REMOVED***. I am from ***REMOVED******REMOVED***hometown***REMOVED******REMOVED***. I have " +
             "***REMOVED******REMOVED***kids.length***REMOVED******REMOVED*** kids:</p>" +
             "<ul>***REMOVED******REMOVED***#kids***REMOVED******REMOVED***<li>***REMOVED******REMOVED***name***REMOVED******REMOVED*** is ***REMOVED******REMOVED***age***REMOVED******REMOVED***</li>***REMOVED******REMOVED***/kids***REMOVED******REMOVED***</ul>";
var template = Handlebars.compile(source);

var data = ***REMOVED*** "name": "Alan", "hometown": "Somewhere, TX",
             "kids": [***REMOVED***"name": "Jimmy", "age": "12"***REMOVED***, ***REMOVED***"name": "Sally", "age": "4"***REMOVED***]***REMOVED***;
