...
break;
case 12:this.$ = ***REMOVED*** path: $$[$0-3], params: $$[$0-2], hash: $$[$0-1] ***REMOVED***;
break;
case 13:this.$ = yy.prepareBlock($$[$0-3], $$[$0-2], $$[$0-1], $$[$0], false, this._$);
break;
case 14:this.$ = yy.prepareBlock($$[$0-3], $$[$0-2], $$[$0-1], $$[$0], true, this._$);
break;
case 15:this.$ = ***REMOVED*** open: $$[$0-5], path: $$[$0-4], params: $$[$0-3], hash: $$[$0-2], blockParams: $$[$0-1], strip: yy.stripFlags($$[$0-5], $$[$0]) ***REMOVED***;
break;
case 16:this.$ = ***REMOVED*** path: $$[$0-4], params: $$[$0-3], hash: $$[$0-2], blockParams: $$[$0-1], strip: yy.stripFlags($$[$0-5], $$[$0]) ***REMOVED***;
break;
case 17:this.$ = ***REMOVED*** path: $$[$0-4], params: $$[$0-3], hash: $$[$0-2], blockParams: $$[$0-1], strip: yy.stripFlags($$[$0-5], $$[$0]) ***REMOVED***;
break;
case 18:this.$ = ***REMOVED*** strip: yy.stripFlags($$[$0-1], $$[$0-1]), program: $$[$0] ***REMOVED***;
break;
case 19:
...
case 20:this.$ = $$[$0];
break;
case 21:this.$ = ***REMOVED***path: $$[$0-1], strip: yy.stripFlags($$[$0-2], $$[$0])***REMOVED***;
break;
...
break;
case 26:this.$ = ***REMOVED*** path: $$[$0-3], params: $$[$0-2], hash: $$[$0-1], strip: yy.stripFlags($$[$0-4], $$[$0]) ***REMOVED***;
break;
case 27:this.$ = $$[$0];
break;
case 28:this.$ = $$[$0];
...
break;
case 30:this.$ = ***REMOVED***type: 'Hash', pairs: $$[$0], loc: yy.locInfo(this._$)***REMOVED***;
break;
case 31:this.$ = ***REMOVED***type: 'HashPair', key: yy.id($$[$0-2]), value: $$[$0], loc: yy.locInfo(this._$)***REMOVED***;
break;
...
case 34:this.$ = $$[$0];
break;
case 35:this.$ = ***REMOVED***type: 'StringLiteral', value: $$[$0], original: $$[$0], loc: yy.locInfo(this._$)***REMOVED***;
break;
case 36:this.$ = ***REMOVED***type: 'NumberLiteral', value: Number($$[$0]), original: Number($$[$0]), loc: yy.locInfo(this._$)***REMOVED***;
break;
case 37:this.$ = ***REMOVED***type: 'BooleanLiteral', value: $$[$0] === 'true', original: $$[$0] === 'true', loc: yy.locInfo(this._$)***REMOVED***;
break;
case 38:this.$ = ***REMOVED***type: 'UndefinedLiteral', original: undefined, value: undefined, loc: yy.locInfo(this._$)***REMOVED***;
break;
case 39:this.$ = ***REMOVED***type: 'NullLiteral', original: null, value: null, loc: yy.locInfo(this._$)***REMOVED***;
break;
case 40:this.$ = $$[$0];
break;
case 41:this.$ = $$[$0];
...
break;
case 44: $$[$0-2].push(***REMOVED***part: yy.id($$[$0]), original: $$[$0], separator: $$[$0-1]***REMOVED***); this.$ = $$[$0-2]; 
break;
case 45:this.$ = [***REMOVED***part: yy.id($$[$0]), original: $$[$0]***REMOVED***];
break;
case 46:this.$ = [];
break;
case 47:$$[$0-1].push($$[$0]);
        ...
        if (typeof action === "undefined" || !action.length || !action[0]) ***REMOVED***
            ...
            if (!recovering) ***REMOVED***
                ...
                for (p in table[state])
                    if (this.terminals_[p] && p > 2) ***REMOVED***
...
parser.lexer = lexer;
function Parser () ***REMOVED*** this.yy = ***REMOVED******REMOVED***; ***REMOVED***Parser.prototype = parser;parser.Parser = Parser;
return new Parser;
