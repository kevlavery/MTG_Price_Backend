...
- The `=` character is now HTML escaped. This closes a potential exploit case when using unquoted attributes, i.e. `<div foo=***REMOVED******REMOVED***bar***REMOVED******REMOVED***>`. In general it's recommended that attributes always be quoted when their values are generated from a mustache to avoid any potential exploit surfaces.
...
- [#910](https://github.com/wycats/handlebars.js/issues/910) - Different behavior of ***REMOVED******REMOVED***@last***REMOVED******REMOVED*** when ***REMOVED******REMOVED***#each***REMOVED******REMOVED*** in ***REMOVED******REMOVED***#each***REMOVED******REMOVED*** ([@zordius](https://api.github.com/users/zordius))
...
- Changes to 0/undefined handling
  - [#731](https://github.com/wycats/handlebars.js/pull/731) - Strange behavior for ***REMOVED******REMOVED***#foo***REMOVED******REMOVED*** ***REMOVED******REMOVED***bar***REMOVED******REMOVED*** ***REMOVED******REMOVED***/foo***REMOVED******REMOVED*** when foo is 0 ([@kpdecker](https://api.github.com/users/kpdecker))
  - [#820](https://github.com/wycats/handlebars.js/issues/820) - strange behavior for ***REMOVED******REMOVED***foo.bar***REMOVED******REMOVED*** when foo is 0 or null or false ([@zordius](https://api.github.com/users/zordius))
...
- [#773](https://github.com/wycats/handlebars.js/issues/773) - Implicit parameters in ***REMOVED******REMOVED***#each***REMOVED******REMOVED*** introduces a peculiarity in helpers calling convention  ([@Bertrand](https://api.github.com/users/Bertrand))
...
- [#852](https://github.com/wycats/handlebars.js/issues/852) - ***REMOVED******REMOVED***foo~***REMOVED******REMOVED*** space control behavior is different from older version ([@zordius](https://api.github.com/users/zordius))
...
- [#671](https://github.com/wycats/handlebars.js/issues/671) - Crashes on no-parameter ***REMOVED******REMOVED***#each***REMOVED******REMOVED*** ([@stepancheg](https://api.github.com/users/stepancheg))
...
- [#646](https://github.com/wycats/handlebars.js/pull/646) - Fix "\\***REMOVED******REMOVED***" immediately following "\***REMOVED******REMOVED***" ([@dmarcotte](https://api.github.com/users/dmarcotte))
...
- [#557](https://github.com/wycats/handlebars.js/pull/557) - `\\***REMOVED******REMOVED***foo***REMOVED******REMOVED***` escaping only works in some situations ([@dmarcotte](https://api.github.com/users/dmarcotte))
...
Compatibility notes:
- The parser is now stricter on `***REMOVED******REMOVED******REMOVED***`, requiring that the end token be `***REMOVED******REMOVED******REMOVED***`. Templates that do not
...
```js
template(context, ***REMOVED***helpers: helpers, partials: partials, data: data***REMOVED***)
```
