...
function loadStrings(opts, callback) ***REMOVED***
  ...
  ***REMOVED***
  ...
  _async2['default'].map(strings, function (string, callback) ***REMOVED***
    if (string !== '-') ***REMOVED***
...
function loadFiles(opts, callback) ***REMOVED***
  ...
  ***REMOVED***);
  _async2['default'].whilst(function () ***REMOVED***
    return queue.length;
...
module.exports.cli = function (opts) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (opts.min) ***REMOVED***
    output = _uglifyJs2['default'].minify(output.code, ***REMOVED***
      fromString: true,
