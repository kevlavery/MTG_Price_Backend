define(['exports', './visitor'], function (exports, _visitor) ***REMOVED***
  ...
  function print(ast) ***REMOVED***
    return new PrintVisitor().accept(ast);
  ***REMOVED***

  function PrintVisitor() ***REMOVED***
    this.padding = 0;
  ***REMOVED***
  ...
  PrintVisitor.prototype.pad = function (string) ***REMOVED***
    ...
    for (var i = 0, l = this.padding; i < l; i++) ***REMOVED***
      out += '  ';
    ***REMOVED***
  ...
  ***REMOVED***;
  ...
  PrintVisitor.prototype.BlockStatement = PrintVisitor.prototype.DecoratorBlock = function (block) ***REMOVED***
    var out = '';
  ...
  ***REMOVED***;
  ...
  PrintVisitor.prototype.Hash = function (hash) ***REMOVED***
    ...
    for (var i = 0, l = pairs.length; i < l; i++) ***REMOVED***
