define(['exports', 'async', 'fs', './handlebars', 'path', 'source-map', 'uglify-js'], function (exports, _async, _fs, _handlebars, _path, _sourceMap, _uglifyJs) ***REMOVED***
  ...
  ***REMOVED***;
  ...
  function loadStrings(opts, callback) ***REMOVED***
    ...
    if (names.length !== strings.length && strings.length > 1) ***REMOVED***
      return callback(new _handlebars.Exception('Number of names did not match the number of string inputs'));
    ***REMOVED***

    _Async['default'].map(strings, function (string, callback) ***REMOVED***
      if (string !== '-') ***REMOVED***
      ...
      ***REMOVED*** else ***REMOVED***
        ...
        ***REMOVED***)();
      ***REMOVED***
    ***REMOVED***, function (err, strings) ***REMOVED***
      strings = strings.map(function (string, index) ***REMOVED***
        return ***REMOVED***
          name: names[index],
          path: names[index],
          source: string
  ...
  ***REMOVED***
  ...
  function loadFiles(opts, callback) ***REMOVED***
    ...
    var extension = (opts.extension || 'handlebars').replace(/[\\^$*+?.():=!|***REMOVED******REMOVED***\-\[\]]/g, function (arg) ***REMOVED***
      return '\\' + arg;
    ***REMOVED***);
    extension = new RegExp('\\.' + extension + '$');

    var ret = [],
        queue = (opts.files || []).map(function (template) ***REMOVED***
      return ***REMOVED*** template: template, root: opts.root ***REMOVED***;
    ***REMOVED***);
    _Async['default'].whilst(function () ***REMOVED***
      return queue.length;
    ***REMOVED***, function (callback) ***REMOVED***
      ...
      _fs2['default'].stat(path, function (err, stat) ***REMOVED***
        if (err) ***REMOVED***
        ...
        ***REMOVED***
        ...
        if (stat.isDirectory()) ***REMOVED***
          ...
          _fs2['default'].readdir(path, function (err, children) ***REMOVED***
            ...
            ***REMOVED***
            children.forEach(function (file) ***REMOVED***
              ...
              if (extension.test(childPath) || _fs2['default'].statSync(childPath).isDirectory()) ***REMOVED***
          ...
          ***REMOVED***);
        ***REMOVED*** else ***REMOVED***
          _fs2['default'].readFile(path, 'utf8', function (err, data) ***REMOVED***
            /* istanbul ignore next : Race condition that being too lazy to test */
            if (err) ***REMOVED***
              return callback(err);
            ***REMOVED***
  ...
  ***REMOVED***
  ...
  module.exports.cli = function (opts) ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (!opts.amd && !opts.commonjs && opts.templates.length === 1 && !opts.templates[0].name) ***REMOVED***
      opts.simple = true;
    ***REMOVED***

    // Convert the known list into a hash
    var known = ***REMOVED******REMOVED***;
    if (opts.known && !Array.isArray(opts.known)) ***REMOVED***
      opts.known = [opts.known];
    ***REMOVED***
    if (opts.known) ***REMOVED***
      for (var i = 0, len = opts.known.length; i < len; i++) ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (opts.min) ***REMOVED***
      output = _uglify['default'].minify(output.code, ***REMOVED***
        fromString: true,
