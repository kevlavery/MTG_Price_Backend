...
IconvLiteEncoderStream.prototype = Object.create(Transform.prototype, ***REMOVED***
    constructor: ***REMOVED*** value: IconvLiteEncoderStream ***REMOVED***
***REMOVED***);
...
IconvLiteEncoderStream.prototype.collect = function(cb) ***REMOVED***
    var chunks = [];
    this.on('error', cb);
    this.on('data', function(chunk) ***REMOVED*** chunks.push(chunk); ***REMOVED***);
...
IconvLiteDecoderStream.prototype = Object.create(Transform.prototype, ***REMOVED***
    constructor: ***REMOVED*** value: IconvLiteDecoderStream ***REMOVED***
***REMOVED***);
...
IconvLiteDecoderStream.prototype.collect = function(cb) ***REMOVED***
    var res = '';
    this.on('error', cb);
    this.on('data', function(chunk) ***REMOVED*** res += chunk; ***REMOVED***);
    this.on('end', function() ***REMOVED***
        cb(null, res);
    ***REMOVED***);
    return this;
