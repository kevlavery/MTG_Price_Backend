...
const ***REMOVED***
  ...
  bidirectional_r_al,
  bidirectional_l,
***REMOVED*** = require('./lib/code-points')
 ...
 * @param ***REMOVED***boolean***REMOVED*** opts.allowUnassigned
 */
function saslprep(input, opts = ***REMOVED******REMOVED***) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (hasBidiRAL && hasBidiL) ***REMOVED***
    throw new Error(
  ...
  ***REMOVED***
  ...
  if (hasBidiRAL && !(isFirstBidiRAL && isLastBidiRAL)) ***REMOVED***
    throw new Error(
