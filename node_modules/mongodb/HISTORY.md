...
* **collection:** allow ***REMOVED*** upsert: 1 ***REMOVED*** for findOneAndUpdate() and update() ([5bcedd6](https://github.com/mongodb/node-mongodb-native/commit/5bcedd6))
...
* NODE-430 Cursor.count() opts argument masked by var opts = ***REMOVED******REMOVED***
...
* Implementing read preference setting at collection and cursor level
   ...
   * db.collection("some", ***REMOVED***readPreference:Server.SECONDARY***REMOVED***)
...
* Allow for force send query to primary, pass option (read:'primary') on find command.
    * ``find(***REMOVED***a:1***REMOVED***, ***REMOVED***read:'primary'***REMOVED***).toArray(function(err, items) ***REMOVED******REMOVED***);``
...
* Eval function no accepts options including nolock (Issue #432)
    * eval(code, parameters, options, callback) (where options = ***REMOVED***nolock:true***REMOVED***)
...
* FindOne and find treats selector == null as ***REMOVED******REMOVED***, Issue #403
...
* Set replicaset read preference replicaset.setReadPreference()
    ...
    * tags, ***REMOVED***object of tags***REMOVED***
...
* Added logger option for Db class, lets you pass in a function in the shape
    ***REMOVED***
        log : function(message, object) ***REMOVED******REMOVED***,
        error : function(errorMessage, errorObject) ***REMOVED******REMOVED***,
        debug : function(debugMessage, object) ***REMOVED******REMOVED***,
    ***REMOVED***

  Usage is new Db(new Server(..), ***REMOVED***logger: loggerInstance***REMOVED***)
...
* Allows for forcing the server to assign ObjectID's using the option ***REMOVED***forceServerObjectId: true***REMOVED***
