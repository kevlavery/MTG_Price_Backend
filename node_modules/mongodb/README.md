...
```js
const insertDocuments = function(db, callback) ***REMOVED***
  // Get the documents collection
  const collection = db.collection('documents');
  // Insert some documents
  collection.insertMany([
    ***REMOVED***a : 1***REMOVED***, ***REMOVED***a : 2***REMOVED***, ***REMOVED***a : 3***REMOVED***
...
MongoClient.connect(url, function(err, client) ***REMOVED***
  ...
  insertDocuments(db, function() ***REMOVED***
    client.close();
  ***REMOVED***);
***REMOVED***);
```
...
```js
const findDocuments = function(db, callback) ***REMOVED***
  // Get the documents collection
  const collection = db.collection('documents');
  // Find some documents
  collection.find(***REMOVED******REMOVED***).toArray(function(err, docs) ***REMOVED***
    assert.equal(err, null);
...
MongoClient.connect(url, function(err, client) ***REMOVED***
  ...
  insertDocuments(db, function() ***REMOVED***
    findDocuments(db, function() ***REMOVED***
      client.close();
    ***REMOVED***);
  ***REMOVED***);
***REMOVED***);
...
const findDocuments = function(db, callback) ***REMOVED***
  ...
  const collection = db.collection('documents');
  // Find some documents
  collection.find(***REMOVED***'a': 3***REMOVED***).toArray(function(err, docs) ***REMOVED***
    assert.equal(err, null);
    console.log("Found the following records");
    console.log(docs);
    callback(docs);
...
```js
const updateDocument = function(db, callback) ***REMOVED***
  // Get the documents collection
  const collection = db.collection('documents');
  // Update document where a is 2, set b equal to 1
  collection.updateOne(***REMOVED*** a : 2 ***REMOVED***
    , ***REMOVED*** $set: ***REMOVED*** b : 1 ***REMOVED*** ***REMOVED***, function(err, result) ***REMOVED***
    assert.equal(err, null);
...
MongoClient.connect(url, function(err, client) ***REMOVED***
  ...
  insertDocuments(db, function() ***REMOVED***
    updateDocument(db, function() ***REMOVED***
      client.close();
    ***REMOVED***);
  ***REMOVED***);
***REMOVED***);
...
```js
const removeDocument = function(db, callback) ***REMOVED***
  // Get the documents collection
  const collection = db.collection('documents');
  // Delete document where a is 3
  collection.deleteOne(***REMOVED*** a : 3 ***REMOVED***, function(err, result) ***REMOVED***
    assert.equal(err, null);
    assert.equal(1, result.result.n);
...
MongoClient.connect(url, function(err, client) ***REMOVED***
  ...
  insertDocuments(db, function() ***REMOVED***
    updateDocument(db, function() ***REMOVED***
      removeDocument(db, function() ***REMOVED***
        client.close();
      ***REMOVED***);
    ***REMOVED***);
  ***REMOVED***);
...
```js
const indexCollection = function(db, callback) ***REMOVED***
...
MongoClient.connect(url, function(err, client) ***REMOVED***
  ...
  insertDocuments(db, function() ***REMOVED***
    indexCollection(db, function() ***REMOVED***
      client.close();
    ***REMOVED***);
  ***REMOVED***);
***REMOVED***);
