...
function applyWriteConcern(target, sources, options) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (options.session && options.session.inTransaction()) ***REMOVED***
    ...
    if (target.writeConcern) ***REMOVED***
 ...
 *
 * @param ***REMOVED***Object***REMOVED*** options The options passed into the method, potentially containing a read preference
 * @param ***REMOVED***Object***REMOVED*** sources Sources from which we can inherit a read preference
 * @returns ***REMOVED***(ReadPreference|null)***REMOVED*** The resolved read preference
 */
function resolveReadPreference(options, sources) ***REMOVED***
  options = options || ***REMOVED******REMOVED***;
  ...
  ***REMOVED*** else if (session && session.inTransaction() && session.transaction.options.readPreference) ***REMOVED***
    // The transaction’s read preference MUST override all other user configurable read preferences.
    readPreference = session.transaction.options.readPreference;
  ***REMOVED*** else ***REMOVED***
    if (coll && coll.s.readPreference) ***REMOVED***
      readPreference = coll.s.readPreference;
    ***REMOVED*** else if (db && db.s.readPreference) ***REMOVED***
      readPreference = db.s.readPreference;
    ***REMOVED*** else if (defaultReadPreference) ***REMOVED***
  ...
  ***REMOVED*** else if (
    ...
    if (mode && typeof mode === 'string') ***REMOVED***
      readPreference = new ReadPreference(mode, readPreference.tags, ***REMOVED***
 ...
 *
 * @param ***REMOVED*******REMOVED*** maybePromise
 * @return true if the provided value is a Promise
 */
function isPromiseLike(maybePromise) ***REMOVED***
 ...
 *
 * @param ***REMOVED***object***REMOVED*** [command] the command on which to apply collation
 * @param ***REMOVED***(Cursor|Collection)***REMOVED*** [target] target of command
 * @param ***REMOVED***object***REMOVED*** [options] options containing collation settings
 */
function decorateWithCollation(command, target, options) ***REMOVED***
 ...
 *
 * @param ***REMOVED***object***REMOVED*** command the command on which to apply the read concern
 * @param ***REMOVED***Collection***REMOVED*** coll the parent collection of the operation calling this method
 */
function decorateWithReadConcern(command, coll) ***REMOVED***
  let readConcern = Object.assign(***REMOVED******REMOVED***, command.readConcern || ***REMOVED******REMOVED***);
  if (coll.s.readConcern) ***REMOVED***
