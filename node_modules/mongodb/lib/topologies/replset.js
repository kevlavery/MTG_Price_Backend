 ...
 * @param ***REMOVED***boolean***REMOVED*** [options.ha=true] Turn on high availability monitoring.
 ...
 * @param ***REMOVED***array***REMOVED*** [options.sslCRL=null] Array of revocation certificates either as Buffers or Strings (needs to have a mongod server with ssl support, 2.4 or higher)
 ...
 * @param ***REMOVED***string***REMOVED*** [options.ciphers=null] Passed directly through to tls.createSecureContext. See https://nodejs.org/dist/latest-v9.x/docs/api/tls.html#tls_tls_createsecurecontext_options for more info.
 * @param ***REMOVED***string***REMOVED*** [options.ecdhCurve=null] Passed directly through to tls.createSecureContext. See https://nodejs.org/dist/latest-v9.x/docs/api/tls.html#tls_tls_createsecurecontext_options for more info.
 ...
 */
class ReplSet extends TopologyBase ***REMOVED***
  constructor(servers, options) ***REMOVED***
    ...
    ***REMOVED***
    ...
    coreTopology.on('reconnect', function() ***REMOVED***
      self.emit('reconnect');
      store.execute();
    ***REMOVED***);
  ...
  ***REMOVED***
  ...
  connect(_options, callback) ***REMOVED***
    ...
    ***REMOVED***);
    ...
    self.s.coreTopology.on('all', function() ***REMOVED***
