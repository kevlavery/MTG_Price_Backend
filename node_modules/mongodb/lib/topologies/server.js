 ...
 */
class Server extends TopologyBase ***REMOVED***
  constructor(host, port, options) ***REMOVED***
    super();
    var self = this;
  ...
  connect(_options, callback) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    var connectHandler = function() ***REMOVED***
      ...
      ['timeout', 'error', 'close', 'destroy'].forEach(function(e) ***REMOVED***
