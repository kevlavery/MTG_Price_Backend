 ...
 * @param ***REMOVED***number***REMOVED*** [options.family] Version of IP stack. Can be 4, 6 or null (default).
 ...
 * @param ***REMOVED***object***REMOVED*** [options.pkFactory] A primary key factory object for generation of custom _id keys
 ...
 * @param ***REMOVED***object***REMOVED*** [options.readConcern] Specify a read concern for the collection (only MongoDB 3.2 or higher supported)
 ...
 * @param ***REMOVED***string***REMOVED*** [options.authMechanism=undefined] Mechanism for authentication: MDEFAULT, GSSAPI, PLAIN, MONGODB-X509, or SCRAM-SHA-1
 * @param ***REMOVED***object***REMOVED*** [options.compression] Type of compression to use: snappy or zlib
 * @param ***REMOVED***boolean***REMOVED*** [options.fsync=false] Specify a file sync write concern
 * @param ***REMOVED***array***REMOVED*** [options.readPreferenceTags] Read preference tags
 ...
 * @param ***REMOVED***boolean***REMOVED*** [options.useNewUrlParser=false] Determines whether or not to use the new url parser
 ...
 * @method
 * @param ***REMOVED***object***REMOVED*** [options] Optional settings.
 * @param ***REMOVED***string***REMOVED*** [options.dbName] Logout against different database than current.
...
MongoClient.prototype.close = function(force, callback) ***REMOVED***
  ...
  for (const name in this.s.dbCache) ***REMOVED***
  ...
  ***REMOVED***
  ...
  return new this.s.promiseLibrary(resolve => ***REMOVED***
    resolve();
  ***REMOVED***);
***REMOVED***;
 ...
 *
 * @method
 * @param ***REMOVED***string***REMOVED*** [dbName] The name of the database we want to use. If not provided, use database name from connection string.
 * @param ***REMOVED***object***REMOVED*** [options] Optional settings.
...
MongoClient.prototype.db = function(dbName, options) ***REMOVED***
  ...
  ***REMOVED***
  ...
  const finalOptions = Object.assign(***REMOVED******REMOVED***, this.s.options, options);
 ...
 * @param ***REMOVED***boolean***REMOVED*** [options.causalConsistency] Indicate that this session should be causally consistent.
 ...
 *
 * @param ***REMOVED***Object***REMOVED*** [options] Optional settings to be appled to implicitly created session
 * @param ***REMOVED***Function***REMOVED*** operation An operation to execute with an implicitly created session. The signature of this MUST be `(session) => ***REMOVED******REMOVED***`
 * @return ***REMOVED***Promise***REMOVED***
 */
MongoClient.prototype.withSession = function(options, operation) ***REMOVED***
  if (typeof options === 'function') (operation = options), (options = undefined);
  const session = this.startSession(options);

  let cleanupHandler = (err, result, opts) => ***REMOVED***
    ...
    ***REMOVED***;
    ...
    opts = Object.assign(***REMOVED*** throw: true ***REMOVED***, opts);
    session.endSession();
  ...
  ***REMOVED***;
  ...
  try ***REMOVED***
    ...
    return Promise.resolve(result)
      ...
      .catch(err => cleanupHandler(err, null, ***REMOVED*** throw: true ***REMOVED***));
  ***REMOVED*** catch (err) ***REMOVED***
    return cleanupHandler(err, null, ***REMOVED*** throw: false ***REMOVED***);
  ***REMOVED***
***REMOVED***;
/**
 ...
 * @param ***REMOVED***ReadPreference***REMOVED*** [options.readPreference] The read preference. See ***REMOVED***@link https://docs.mongodb.com/manual/reference/read-preference|read preference documentation***REMOVED***.
 ...
 */
MongoClient.prototype.watch = function(pipeline, options) ***REMOVED***
  pipeline = pipeline || [];
  options = options || ***REMOVED******REMOVED***;
