 ...
 *
 * @method
 * @param ***REMOVED***object***REMOVED*** updateDocument update operations
 ...
 *
 * @method
 * @param ***REMOVED***object***REMOVED*** updateDocument the new document to replace the existing one with
 * @throws ***REMOVED***MongoError***REMOVED***
 * @return ***REMOVED***FindOperatorsUnordered***REMOVED***
 */
...
var addToOperationsList = function(_self, docType, document) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (docType === common.INSERT) ***REMOVED***
    ...
    _self.s.bulkResult.insertedIds.push(***REMOVED***
 ...
 *
 * @param ***REMOVED***object***REMOVED*** document the document to insert
 * @throws ***REMOVED***MongoError***REMOVED***
...
//
// Execute the command
var executeBatch = function(self, batch, options, callback) ***REMOVED***
  var finalOptions = Object.assign(***REMOVED*** ordered: false ***REMOVED***, options);
...
var executeBatches = function(self, options, callback) ***REMOVED***
  var numberOfCommandsToExecute = self.s.batches.length;
  // Execute over all the batches
  for (var i = 0; i < self.s.batches.length; i++) ***REMOVED***
    executeBatch(self, self.s.batches[i], options, function(err) ***REMOVED***
 ...
 */
UnorderedBulkOperation.prototype.execute = function(_writeConcern, options, callback) ***REMOVED***
