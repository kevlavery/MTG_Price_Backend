...
var executeCommands = function(self, options, callback) ***REMOVED***
  ...
  ***REMOVED***
  ...
  var resultHandler = function(err, result) ***REMOVED***
    ...
    if (((err && err.driver) || (err && err.message)) && !(err instanceof MongoWriteConcernError)) ***REMOVED***
      return handleCallback(callback, err);
    ***REMOVED***

    // If we have and error
    if (err) err.ok = 0;
    if (err instanceof MongoWriteConcernError) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (finalOptions.retryWrites) ***REMOVED***
