 ...
 * @param ***REMOVED***object***REMOVED*** [options.writeConcern] Optional write concern to be passed to write operations, for instance `***REMOVED*** w: 1 ***REMOVED***`
 * @param ***REMOVED***object***REMOVED*** [options.readPreference] Optional read preference to be passed to read operations
 ...
 * @param ***REMOVED***object***REMOVED*** [options] Optional settings.
 * @param ***REMOVED***number***REMOVED*** [options.chunkSizeBytes] Optional overwrite this bucket's chunkSizeBytes for this file
 * @param ***REMOVED***object***REMOVED*** [options.metadata] Optional object to store in the file document's `metadata` field
 * @param ***REMOVED***string***REMOVED*** [options.contentType] Optional string to store in the file document's `contentType` field
 * @param ***REMOVED***array***REMOVED*** [options.aliases] Optional array of strings to store in the file document's `aliases` field
 ...
 * @param ***REMOVED***Object***REMOVED*** [options] Optional settings.
 * @param ***REMOVED***Number***REMOVED*** [options.start] Optional 0-based offset in bytes to start streaming from
 * @param ***REMOVED***Number***REMOVED*** [options.end] Optional 0-based offset in bytes to stop streaming before
...
GridFSBucket.prototype.delete = function(id, callback) ***REMOVED***
  return executeOperation(this.s.db.s.topology, _delete, [this, id, callback], ***REMOVED***
    skipSessions: true
  ***REMOVED***);
***REMOVED***;
 ...
 * @param ***REMOVED***Object***REMOVED*** [options] Optional settings for cursor
 * @param ***REMOVED***number***REMOVED*** [options.batchSize] Optional batch size for cursor
 * @param ***REMOVED***number***REMOVED*** [options.limit] Optional limit for cursor
 * @param ***REMOVED***number***REMOVED*** [options.maxTimeMS] Optional maxTimeMS for cursor
 * @param ***REMOVED***boolean***REMOVED*** [options.noCursorTimeout] Optionally set cursor's `noCursorTimeout` flag
 * @param ***REMOVED***number***REMOVED*** [options.skip] Optional skip for cursor
 * @param ***REMOVED***object***REMOVED*** [options.sort] Optional sort for cursor
...
GridFSBucket.prototype.rename = function(id, filename, callback) ***REMOVED***
  return executeOperation(this.s.db.s.topology, _rename, [this, id, filename, callback], ***REMOVED***
    skipSessions: true
  ***REMOVED***);
***REMOVED***;
...
GridFSBucket.prototype.drop = function(callback) ***REMOVED***
  return executeOperation(this.s.db.s.topology, _drop, [this, callback], ***REMOVED***
    skipSessions: true
  ***REMOVED***);
***REMOVED***;
