...
function isGetMoreError(error) ***REMOVED***
  if (error[mongoErrorContextSymbol]) ***REMOVED***
    return error[mongoErrorContextSymbol].isGetMore;
  ***REMOVED***
***REMOVED***

function isResumableError(error) ***REMOVED***
  if (!isGetMoreError(error)) ***REMOVED***
    return false;
  ***REMOVED***
...
module.exports = ***REMOVED*** GET_MORE_NON_RESUMABLE_CODES, isResumableError ***REMOVED***;
