...
fs.stat(filename, function (err1) ***REMOVED***
...
var err2 = new VError(***REMOVED***
    ...
    'info': ***REMOVED***
        ...
        'port': 215
    ***REMOVED***
***REMOVED***, 'failed to connect to "%s:%d"', '127.0.0.1', 215);
...
This outputs:
    ...
    ConnectionError
    ***REMOVED*** errno: 'ECONNREFUSED', remote_ip: '127.0.0.1', port: 215 ***REMOVED***
...
```javascript
var err3 = new VError(***REMOVED***
    'name': 'RequestError',
    'cause': err2,
    'info': ***REMOVED***
        'errno': 'EBADREQUEST'
    ***REMOVED***
***REMOVED***, 'request failed');
...
This outputs:
    ...
    RequestError
    ***REMOVED*** errno: 'EBADREQUEST', remote_ip: '127.0.0.1', port: 215 ***REMOVED***
